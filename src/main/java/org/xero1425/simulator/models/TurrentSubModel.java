...
public class TurrentSubModel {
    ...
    public TurrentSubModel(SimMotorController motor, double deg_per_power_per_sec, int encoder, double rmax, double rmin, double emax, double emin, double rc, double ec) {
        motor_ = motor ;
        angle_ = 0.0 ;
